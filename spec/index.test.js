...
describe("index", () => {
	...
	describe("--optional", () => {
		for (const opt of ["--save-optional", "--optional", "-O"]) {
			...
			runTest(
				"pnpm",
				["add", "--save-optional", "p1", "p2"],
				["i", opt, "p1", "p2"],
				pnpmLock,
			);
			runTest(
				"npm",
				["uninstall", "--save-optional", "p1", "p2"],
				["un", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
				["remove", "--optional", "p1", "p2"],
				["un", opt, "p1", "p2"],
				yarnLock,
			);
			runTest(
				"pnpm",
				["remove", "--save-optional", "p1", "p2"],
				["un", opt, "p1", "p2"],
				pnpmLock,
			);
	...
	describe("--no-optional", () => {
		for (const opt of ["--no-optional", "--ignore-optional"]) {
			runTest(
				"npm",
				["install", "--omit optional", "p1", "p2"],
				["i", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
				["add", "--no-optional", "p1", "p2"],
				["i", opt, "p1", "p2"],
				yarnLock,
			);
			runTest(
			...
			runTest(
				"npm",
				["uninstall", "--omit optional", "p1", "p2"],
				["un", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
				["remove", "--no-optional", "p1", "p2"],
				["un", opt, "p1", "p2"],
				yarnLock,
			);
			runTest(
	...
	describe("--no-peer", () => {
		for (const opt of ["--no-peer", "--ignore-peer"]) {
			...
			runTest(
				"npm",
				["uninstall", "--omit peer", "p1", "p2"],
				["un", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
				["remove", "--no-peer", "p1", "p2"],
				["un", opt, "p1", "p2"],
				yarnLock,
			);
			runTest(
	...
	describe("--exact", () => {
		for (const opt of ["--save-exact", "--exact", "-E"]) {
			...
			runTest(
				"pnpm",
				["add", "--save-exact", "p1", "p2"],
				["i", opt, "p1", "p2"],
				pnpmLock,
			);
			runTest(
				"npm",
				["uninstall", "--save-exact", "p1", "p2"],
				["un", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
	...
	describe("--global", () => {
		for (const opt of ["--global", "-g"]) {
			runTest(
				"npm",
				["install", "--global", "p1", "p2"],
				["i", opt, "p1", "p2"],
			);
			runTest(
				"yarn",
				new Error("Yarn doesn't install global dependencies."),
				["i", opt, "p1", "p2"],
				yarnLock,
			);
			runTest(
